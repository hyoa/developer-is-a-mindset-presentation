...
const images = {
  ...
  stereotype: require('../assets/stereotype.jpg'),
  stereotype2: require('../assets/stereotype2.gif'),
  stereotype4: require('../assets/stereotype4.png'),
  ...
  bgReality: require('../assets/bg_reality.jpg')
};
  ...
  render() {
    return (
      ...
      >
        ...
        <Slide bgColor="dark" textColor="primary" transition={['fade']}>
          ...
          <List textAlign="center">
            ...
            <Appear>
              <ListItem textSize="30" style={{ marginTop: '1rem' }}>
                "Ca tombe bien, j'ai un problème avec mon ordinateur..."
              </ListItem>
            </Appear>
          </List>
        </Slide>
        ...
        <Slide bgColor="dark" transition={['fade']}>
        ...
        <Slide bgColor="dark" transition={['fade']}>
          <Image src={images.stereotype} width={500} />
        </Slide>
        <Slide bgColor="dark" transition={['fade']}>
        ...
        <Slide bgImage={images.bgReality} bgDarken={0.5} transition={['fade']}>
        ...
        <Slide bgImage={images.bgThanks} bgDarken={0.4} transition={['fade']}>
          <Heading textColor="primary">Merci à tous !</Heading>
        </Slide>
      </Deck>
    );
  }
